...
*/
Trade.cancelOrderByClientId = async function(params) {
  let endpoint = '/api/v1/order/client-order/' + params.id 
  delete params.id
  let url = this.baseURL + endpoint
  let result = await axios.delete(url, this.sign(endpoint, params, 'DELETE'))
  return result.data
...
*/
Trade.getOrderByClientId = async function(params) {
  let endpoint = '/api/v1/order/client-order/' + params.id
  delete params.id
  let url = this.baseURL + endpoint
  let result = await axios.get(url, this.sign(endpoint, params, 'GET'))
...
*/
Trade.placeStopOrder = async function(params) {
  let endpoint = '/api/v1/stop-order'
  let url = this.baseURL + endpoint
  let result = await axios.post(url, params, this.sign(endpoint, params,'POST'))
  return result.data
}
